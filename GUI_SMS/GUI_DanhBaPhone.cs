    ...
    public partial class GUI_DanhBaPhone : Form
    {
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            if (tf1)
            {
                tf = !tf;
                Lock_Unlock(tf);
                txtgioitinh.Text = txtsodt.Text = txtnhom.Text = txtdiachi.Text = txthoten.Text = "";
                txthoten.Focus();
            }
        ...
        {
            btnNew.Enabled = tf;
            btnAdd.Enabled = txthoten.Enabled = txtgioitinh.Enabled = txtsodt.Enabled = txtnhom.Enabled = txtdiachi.Enabled = !tf;
        }
        void Lock_Unlock1(bool tf1)
        {
            dgvDanhBaPhone.Enabled = tf1;
            btnDelete.Enabled = btnUpdate.Enabled = txthoten.Enabled = txtgioitinh.Enabled = txtsodt.Enabled = txtnhom.Enabled = txtdiachi.Enabled = !tf1;
        }
